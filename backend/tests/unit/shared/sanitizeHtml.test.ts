...
describe("sanitizeDescriptionHtml", () => {
  it("giữ lại các thẻ định dạng cơ bản khớp bộ nút RichTextEditor", () => {
    const html = "<p>Bó hoa <strong>hồng đỏ</strong> <em>tươi</em>, gồm:</p><ul><li>10 bông hồng</li></ul>";
  ...
  it("xoá mọi attribute, kể cả href/onclick — mô tả sản phẩm không cần link", () => {
    const result = sanitizeDescriptionHtml('<p onclick="alert(1)">Click</p><a href="javascript:alert(1)">link</a>');
