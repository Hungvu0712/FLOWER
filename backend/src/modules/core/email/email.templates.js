...
// Khi cần layout đẹp hơn, thay bằng react-email hoặc mjml mà không đổi email.service.js.
...
function newPasswordTemplate({ password }) {
  return `
    <p>Chào bạn,</p>
...
module.exports = { magicLinkTemplate, passwordResetTemplate, newPasswordTemplate };
