...
ordersAdminRouter.get("/", authorize("orders.view_all"), validate({ query: listOrdersQuerySchema }), controller.listAdmin);
ordersAdminRouter.get("/:id", authorize("orders.view_all"), validate({ params: orderIdParamSchema }), controller.getById);
