---
description: Nơi ghi lại mọi trao đổi, quyết định đã chốt và các mục đang chờ bạn quyết định.
---
...
| 09/2026 | Mức độ đầu tư cho kiểm thử tự động | **Cao** — 466 bài kiểm thử | Giảm rủi ro phụ thuộc một lập trình viên — [xem R3](05-rui-ro.md) |
...
```mermaid
flowchart LR
    A["💬 Bạn nêu<br/>yêu cầu mới"] --> B["📝 Ghi vào bảng<br/>bên dưới"]
    B --> C["⏱️ Đội phát triển<br/>báo ước lượng<br/>trong 2 ngày làm việc"]
    C --> D{"Bạn quyết định"}
    D -->|"Làm ngay"| E["📅 Dời mốc tương ứng<br/>cập nhật Tiến độ"]
    D -->|"Để giai đoạn sau"| F["📌 Đưa vào danh sách chờ<br/>giữ nguyên mốc hiện tại"]
    D -->|"Không làm"| G["❌ Đóng, ghi lý do"]
...
Toàn bộ mã nguồn và tài liệu thuộc về bạn. Dự án có 20 tài liệu kỹ thuật kèm sơ đồ và 466 bài kiểm
