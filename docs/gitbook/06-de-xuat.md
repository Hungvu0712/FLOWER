...
**Đề xuất.** Cấu hình hệ thống tự động chạy toàn bộ 577 bài kiểm thử mỗi lần có code mới, **chặn
không cho gộp** nếu có bài nào thất bại.

```mermaid
flowchart LR
    D["👨‍💻 Lập trình viên<br/>nộp code"] --> CI["🤖 Máy tự động chạy<br/>577 bài kiểm thử<br/>+ kiểm tra chất lượng"]
...
| **Điều kiện thuận lợi** | ✅ Tài liệu đầy đủ và ✅ 577 bài kiểm thử tự động — người mới hoà nhập trong **1–2 tuần**, không phải 1–2 tháng |
