...
| Số bài kiểm thử tự động đang chạy | **557** (backend 446 · giao diện 111) + ~30 kịch bản mô phỏng người dùng |
...
| Việc | Kết quả |
|---|---|
| **Bổ sung 557 bài kiểm thử tự động** | Toàn bộ phần nền tảng nay được kiểm tra tự động mỗi lần sửa code |
