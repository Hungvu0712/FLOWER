...
| Số bài kiểm thử tự động đang chạy | **435** (backend 334 · giao diện 101) + ~30 kịch bản mô phỏng người dùng |
...
| Việc | Kết quả |
|---|---|
| **Bổ sung 435 bài kiểm thử tự động** | Toàn bộ phần nền tảng nay được kiểm tra tự động mỗi lần sửa code |
