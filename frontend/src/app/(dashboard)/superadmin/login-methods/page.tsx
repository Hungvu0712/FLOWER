...
import {
  ...
  useUpdateLoginMethod,
} from '@/features/core/admin-login-methods/loginMethods.hooks';
...
const METHOD_INFO: Record<string, { label: string; description: string }> = {
  ...
  email_password: {
    ...
    description: 'Phương thức đăng nhập truyền thống bằng email và mật khẩu.',
  },
  magic_link: {
    label: 'Magic link',
    description: 'Gửi liên kết đăng nhập một lần qua email, không cần mật khẩu.',
  },
};
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Bật/tắt các phương thức xác thực cho toàn hệ thống."
      />
                ...
                <div>
                  ...
                  {isLastEnabled && (
                    <p className="mt-2 text-xs text-amber-600">
                      Đây là phương thức duy nhất đang bật — không thể tắt (luôn cần tối thiểu 1
                      phương thức).
                    </p>
                  )}
                </div>
