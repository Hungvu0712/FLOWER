...
// Next.js 16: quy ước "proxy" (đổi tên từ "middleware"). Chặn sớm theo phạm vi truy cập — chỉ kiểm
// tra "đã đăng nhập" + role thô ở đây; permission chi tiết theo từng trang được kiểm tra lại trong
// layout tương ứng (Server Component) VÀ luôn được backend authorize() kiểm tra lại lần nữa — proxy
// chỉ để redirect sớm cho trải nghiệm mượt hơn, KHÔNG phải lớp bảo mật duy nhất.
// Xem ARCHITECTURE.md §14, SECURITY.md §2.
