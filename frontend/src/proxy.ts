...
// role/permission (xem backend shared/utils/jwt.ts), và dù có nhúng thì token cũ vẫn có thể sai lệch với
...
//      request (xem shared/middleware/authenticate.ts).
// Xem docs/02 §8, docs/04 §3, docs/07 §2.
