...
export function ProductCard({
  ...
  return (
    <div className="flex flex-col gap-3.5 rounded-2xl border border-border-soft/70 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
