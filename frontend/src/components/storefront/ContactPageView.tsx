...
// Client Component — form liên hệ cần useState/mutation. page.tsx (Server Component) fetch
// `siteContent` (hotline/Zalo/địa chỉ/giờ mở cửa, admin sửa qua /admin/site-content) rồi truyền
// xuống đây, giống hệt pattern OrderConfirmationView — xem docs/modules/domain-site-content.md.
    ...
    <div>
      ...
      <section className="bg-rose-light px-8 py-16 text-center lg:px-16">
        ...
        <p className="mx-auto mt-4 max-w-xl text-ink-muted">
          Gọi điện hoặc nhắn Zalo để được tư vấn nhanh nhất, mở cửa {openHours}. Ngoài giờ vẫn có
      ...
      <section className="px-8 py-16 lg:px-16">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-4">
              <InfoRow label="Hotline đặt hoa" value={hotline} href={`tel:${hotlineTel}`} />
              <InfoRow label="Zalo" value={zaloDisplay} href={zaloLink} />
              <InfoRow label="Địa chỉ" value={address} />
              <InfoRow label="Giờ mở cửa" value={openHours} />
            </div>
          </div>
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <PillLink
              ...
              href={`tel:${hotlineTel}`}
            />
            <PillLink icon={ZaloIcon} label="Nhắn tin Zalo" value={zaloDisplay} href={zaloLink} />
          </div>
        </div>
      </section>
    </div>
