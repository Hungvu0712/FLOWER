...
export async function login(
  ...
  // exact:true — trang /login còn nút "Đăng nhập bằng liên kết qua email" (magic_link, xem
  // src/app/(auth)/login/page.tsx) cũng khớp regex /đăng nhập/i, khiến Playwright strict mode báo lỗi
  // "resolved to 2 elements" khi magic_link đang bật (seed CI bật mặc định — bug thật phát hiện lúc
  // chạy E2E thật lần đầu trên CI, máy dev không thấy vì chưa từng bật magic_link cục bộ).
