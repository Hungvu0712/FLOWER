...
- [x] **Uptime monitor trỏ vào `/health`** *(14/09/2026 — UptimeRobot free (50 monitor, check mỗi 5 phút), cảnh báo qua email. 2 monitor `HTTP(s)`: `https://api.thuymaiflower.click/health` và `https://thuymaiflower.click`. Xác nhận THẬT: cả 2 đều "Up", uptime 100%)*
